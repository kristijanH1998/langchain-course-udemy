...
def implement_llama_4_model():
    ...
    llama4_instance = ChatGroq("llama-4-8b-instant", 0)
    return llama4_instance
    pass
...
def implement_llama_3_3_model():
    ...
    """
    # TODO: Your implementation here
    llama33_instance = ChatGroq("llama-3.3-70b-versatile", 0.3)
    return llama33_instance
    pass
...
def implement_query_model(model, prompt):
    ...
    # TODO: Your implementation here
    messages = [prompt]
    mock_message = model.invoke(messages)
    response = mock_message.content
    return response
    pass
...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    llama4_inst = implement_llama_4_model()
    llama33_inst = implement_llama_3_3_model()
    messages = [prompt]
    res1 = llama4_inst.invoke(messages)
    res2 = llama33_inst.invoke(messages)
    res_dict = {
        "response1": res1,
        "response2": res2
    }
